...
type RecordShoeStartedRequest struct {
	...
	TsStart *timestamppb.Timestamp `protobuf:"bytes,16,opt,name=ts_start,json=tsStart,proto3" json:"tsStart" bson:"tsStart" yaml:"tsStart"`
	// cardList
	Decks map[int32]*Deck `protobuf:"bytes,24,rep,name=decks,proto3" json:"decks" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" yaml:"decks" bson:"decks"`
}
...
type RecordRoundStepsRequest struct {
	...
	RecordId []byte `protobuf:"bytes,1,opt,name=record_id,json=recordId,proto3" json:"recordId" bson:"recordId" yaml:"recordId"`
	// 步驟
	Steps []*Step `protobuf:"bytes,26,rep,name=steps,proto3" json:"steps" yaml:"steps" bson:"steps"`
}
...
type RecordRoundMediaRequest struct {
	...
	// 附加媒體：key: 媒體資源代碼；value: 媒體內容。
	Add map[string]string `protobuf:"bytes,3,rep,name=add,proto3" json:"add" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" yaml:"add" bson:"add"`
	// 移除
...
var file_recorder_recorder_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x08, 0x63, 0x61, 0x72, 0x64, 0x43, 0x6f, 0x64, 0x65, 0x32, 0xfe, 0x07, 0x0a, 0x0f,
	...
	,
...
var file_recorder_recorder_proto_depIdxs = []int32{
	...
	10, // 28: recorder.RecorderService.RecordFinishResultAfterRound:input_type -> recorder.RecordModifyCardRequest
	9,  // 29: recorder.RecorderService.RecordRoundVideo:input_type -> recorder.RecordRoundMediaRequest
	23, // 30: recorder.RecorderService.RecordShiftStarted:output_type -> recorder.ShiftRecord
	23, // 31: recorder.RecorderService.RecordShiftEnded:output_type -> recorder.ShiftRecord
	24, // 32: recorder.RecorderService.RecordShoeStarted:output_type -> recorder.ShoeRecord
	24, // 33: recorder.RecorderService.RecordShoeEnded:output_type -> recorder.ShoeRecord
	25, // 34: recorder.RecorderService.RecordRoundStarted:output_type -> recorder.RoundRecord
	25, // 35: recorder.RecorderService.RecordRoundSteps:output_type -> recorder.RoundRecord
	25, // 36: recorder.RecorderService.RecordRoundBeCanceled:output_type -> recorder.RoundRecord
	25, // 37: recorder.RecorderService.RecordRoundFinished:output_type -> recorder.RoundRecord
	25, // 38: recorder.RecorderService.RecordRoundBeCanceledAfterFinished:output_type -> recorder.RoundRecord
	25, // 39: recorder.RecorderService.RecordModifyResultAfterRound:output_type -> recorder.RoundRecord
	25, // 40: recorder.RecorderService.RecordFinishResultAfterRound:output_type -> recorder.RoundRecord
	25, // 41: recorder.RecorderService.RecordRoundVideo:output_type -> recorder.RoundRecord
