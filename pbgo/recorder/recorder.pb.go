...
type RecordShoeStartedRequest struct {
	...
	// cut_round
	CutRound int32 `protobuf:"varint,11,opt,name=cut_round,json=cutRound,proto3" json:"cut_round,omitempty"`
	// 此牌靴開始使用時間
	TsStart *timestamppb.Timestamp `protobuf:"bytes,16,opt,name=ts_start,json=tsStart,proto3" json:"ts_start,omitempty"`
	// cardList
...
type RecordRoundMediaRequest struct {
	...
	// 附加媒體：key: 媒體資源代碼；value: 媒體內容。
	Add map[string]string `protobuf:"bytes,3,rep,name=add,proto3" json:"add,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// 移除
...
type RecordModifyCardRequest struct {
	...
	// 修改fortune
	ModifyFortune map[string]int64 `protobuf:"bytes,6,rep,name=modify_fortune,json=modifyFortune,proto3" json:"modify_fortune,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
