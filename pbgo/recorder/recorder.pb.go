...
type RecordModifyCardRequest struct {
	...
	// 修改fortune
	ModifyFortune map[string]int64 `protobuf:"bytes,6,rep,name=modify_fortune,json=modifyFortune,proto3" json:"modifyFortune" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3" yaml:"modifyFortune" bson:"modifyFortune"`
}
