...
type Result struct {
	...
	// 時間戳
	Timestamp *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=timestamp,proto3" json:"timestamp" yaml:"timestamp" bson:"timestamp"`
	// 座位組
...
var file_recorder_record_proto_rawDesc = []byte{
	...
	0x10, 0x03, 0x12, 0x08, 0x0a, 0x04, 0x43, 0x41, 0x52, 0x44, 0x10, 0x04, 0x42, 0x8d, 0x01, 0x0a,
