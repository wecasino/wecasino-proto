...
type RoundRecord struct {
	...
	// 贏方
	WinType map[int32]games.WinType `protobuf:"bytes,27,rep,name=win_type,json=winType,proto3" json:"winType" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value,enum=games.WinType" yaml:"winType" bson:"winType,omitempty"`
