...
const (
	...
	RecorderReadService_GetRoundsByShoe_FullMethodName  = "/recorder.RecorderReadService/GetRoundsByShoe"
...
type RecorderReadServiceClient interface {
	...
	// 讀取整靴局紀錄
	GetRoundsByShoe(ctx context.Context, in *GetRoundsByShoeRequest, opts ...grpc.CallOption) (*GetRoundsByShoeResponse, error)
	// 讀牌局紀錄list
...
func (c *recorderReadServiceClient) GetRoundsByShoe(ctx context.Context, in *GetRoundsByShoeRequest, opts ...grpc.CallOption) (*GetRoundsByShoeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetRoundsByShoeResponse)
	err := c.cc.Invoke(ctx, RecorderReadService_GetRoundsByShoe_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RecorderReadServiceServer interface {
	...
	// 讀取整靴局紀錄
	GetRoundsByShoe(context.Context, *GetRoundsByShoeRequest) (*GetRoundsByShoeResponse, error)
	// 讀牌局紀錄list
...
func (UnimplementedRecorderReadServiceServer) GetCurrentShift(context.Context, *GetCurrentRecordRequest) (*ShiftRecord, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCurrentShift not implemented")
}
func (UnimplementedRecorderReadServiceServer) ListShoe(context.Context, *ListRecordsRequest) (*ListShoesRecordResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListShoe not implemented")
}
func (UnimplementedRecorderReadServiceServer) GetShoe(context.Context, *GetRequest) (*ShoeRecord, error) {
	return nil, status.Error(codes.Unimplemented, "method GetShoe not implemented")
}
func (UnimplementedRecorderReadServiceServer) GetCurrentShoe(context.Context, *GetCurrentRecordRequest) (*ShoeRecord, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCurrentShoe not implemented")
}
func (UnimplementedRecorderReadServiceServer) GetRoundsByShoe(context.Context, *GetRoundsByShoeRequest) (*GetRoundsByShoeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetRoundsByShoe not implemented")
}
...
func (UnimplementedRecorderReadServiceServer) GetRound(context.Context, *GetRequest) (*RoundRecord, error) {
	return nil, status.Error(codes.Unimplemented, "method GetRound not implemented")
}
...
func (UnimplementedRecorderReadServiceServer) GetPlayBackRound(context.Context, *GetRoundPlayBackRequest) (*GetRoundPlayBackResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetPlayBackRound not implemented")
}
...
func RegisterRecorderReadServiceServer(s grpc.ServiceRegistrar, srv RecorderReadServiceServer) {
	// If the following call panics, it indicates UnimplementedRecorderReadServiceServer was
...
func _RecorderReadService_GetRoundsByShoe_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetRoundsByShoeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RecorderReadServiceServer).GetRoundsByShoe(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RecorderReadService_GetRoundsByShoe_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RecorderReadServiceServer).GetRoundsByShoe(ctx, req.(*GetRoundsByShoeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RecorderReadService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetRoundsByShoe",
			Handler:    _RecorderReadService_GetRoundsByShoe_Handler,
		},
		{
...
const (
	...
	ProviderService_InputLuckyRecord_FullMethodName    = "/recorder.ProviderService/InputLuckyRecord"
...
func (UnimplementedProviderServiceServer) ListDealers(context.Context, *ListDealersRequest) (*ListDealersResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListDealers not implemented")
}
func (UnimplementedProviderServiceServer) GetDealer(context.Context, *GetRequest) (*Dealer, error) {
	return nil, status.Error(codes.Unimplemented, "method GetDealer not implemented")
}
...
func _ProviderService_InputLuckyRecord_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InputLuckyRecordRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProviderServiceServer).InputLuckyRecord(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProviderService_InputLuckyRecord_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProviderServiceServer).InputLuckyRecord(ctx, req.(*InputLuckyRecordRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProviderService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "InputLuckyRecord",
			Handler:    _ProviderService_InputLuckyRecord_Handler,
		},
		{
