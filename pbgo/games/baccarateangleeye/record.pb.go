...
func (GameSubtype) Descriptor() protoreflect.EnumDescriptor {
	return file_games_baccarateangleeye_record_proto_enumTypes[0].Descriptor()
}

func (GameSubtype) Type() protoreflect.EnumType {
	return &file_games_baccarateangleeye_record_proto_enumTypes[0]
}
...
func (GameSubtype) EnumDescriptor() ([]byte, []int) {
	return file_games_baccarateangleeye_record_proto_rawDescGZIP(), []int{0}
}
...
func (ResourceType) Descriptor() protoreflect.EnumDescriptor {
	return file_games_baccarateangleeye_record_proto_enumTypes[1].Descriptor()
}

func (ResourceType) Type() protoreflect.EnumType {
	return &file_games_baccarateangleeye_record_proto_enumTypes[1]
}
...
func (ResourceType) EnumDescriptor() ([]byte, []int) {
	return file_games_baccarateangleeye_record_proto_rawDescGZIP(), []int{1}
}
...
func (Step) Descriptor() protoreflect.EnumDescriptor {
	return file_games_baccarateangleeye_record_proto_enumTypes[2].Descriptor()
}

func (Step) Type() protoreflect.EnumType {
	return &file_games_baccarateangleeye_record_proto_enumTypes[2]
}
...
func (Step) EnumDescriptor() ([]byte, []int) {
	return file_games_baccarateangleeye_record_proto_rawDescGZIP(), []int{2}
}
...
func (GameSeat) Descriptor() protoreflect.EnumDescriptor {
	return file_games_baccarateangleeye_record_proto_enumTypes[3].Descriptor()
}

func (GameSeat) Type() protoreflect.EnumType {
	return &file_games_baccarateangleeye_record_proto_enumTypes[3]
}
...
func (GameSeat) EnumDescriptor() ([]byte, []int) {
	return file_games_baccarateangleeye_record_proto_rawDescGZIP(), []int{3}
}

var File_games_baccarateangleeye_record_proto protoreflect.FileDescriptor

const file_games_baccarateangleeye_record_proto_rawDesc = "" +
	"\n" +
	"$games/baccarateangleeye/record.proto\x12\x16games.baccaratangleeye*B\n" +
	...
	"\n" +
	"\x06BANKER\x10\x03B\xf2\x01\n" +
	")com.wecasino.proto.games.baccaratangleeyeB\vRecordProtoP\x01Z?github.com/wecasino/wecasino-proto/pbgo/games/baccarateangleeye\xa2\x02\x03GBX\xaa\x02\x16Games.Baccaratangleeye\xca\x02\x16Games\\Baccaratangleeye\xe2\x02\"Games\\Baccaratangleeye\\GPBMetadata\xea\x02\x17Games::Baccaratangleeyeb\x06proto3"

var (
	file_games_baccarateangleeye_record_proto_rawDescOnce sync.Once
	file_games_baccarateangleeye_record_proto_rawDescData []byte
)

func file_games_baccarateangleeye_record_proto_rawDescGZIP() []byte {
	file_games_baccarateangleeye_record_proto_rawDescOnce.Do(func() {
		file_games_baccarateangleeye_record_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_games_baccarateangleeye_record_proto_rawDesc), len(file_games_baccarateangleeye_record_proto_rawDesc)))
	})
	return file_games_baccarateangleeye_record_proto_rawDescData
}

var file_games_baccarateangleeye_record_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_games_baccarateangleeye_record_proto_goTypes = []any{
	(GameSubtype)(0),  // 0: games.baccaratangleeye.GameSubtype
	(ResourceType)(0), // 1: games.baccaratangleeye.ResourceType
	(Step)(0),         // 2: games.baccaratangleeye.Step
	(GameSeat)(0),     // 3: games.baccaratangleeye.GameSeat
}
var file_games_baccarateangleeye_record_proto_depIdxs = []int32{
...
func init() { file_games_baccarateangleeye_record_proto_init() }
func file_games_baccarateangleeye_record_proto_init() {
	if File_games_baccarateangleeye_record_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_games_baccarateangleeye_record_proto_rawDesc), len(file_games_baccarateangleeye_record_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_games_baccarateangleeye_record_proto_goTypes,
		DependencyIndexes: file_games_baccarateangleeye_record_proto_depIdxs,
		EnumInfos:         file_games_baccarateangleeye_record_proto_enumTypes,
	}.Build()
	File_games_baccarateangleeye_record_proto = out.File
	file_games_baccarateangleeye_record_proto_goTypes = nil
	file_games_baccarateangleeye_record_proto_depIdxs = nil
}
