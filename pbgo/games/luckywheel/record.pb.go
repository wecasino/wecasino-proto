...
const file_games_luckywheel_record_proto_rawDesc = "" +
	"\n" +
	...
	"\n" +
	"SPIN_WHEEL\x10\b\x12\x17\n" +
	"\x13PITBOSS_MODIFY_BOWL\x10\x10B\xcd\x01\n" +
	"#com.wecasino.proto.games.luckywheelB\vRecordProtoP\x01Z8github.com/wecasino/wecasino-proto/pbgo/games/luckywheel\xa2\x02\x03GLX\xaa\x02\x10Games.Luckywheel\xca\x02\x10Games\\Luckywheel\xe2\x02\x1cGames\\Luckywheel\\GPBMetadata\xea\x02\x11Games::Luckywheelb\x06proto3"

var (
	file_games_luckywheel_record_proto_rawDescOnce sync.Once
	file_games_luckywheel_record_proto_rawDescData []byte
)

func file_games_luckywheel_record_proto_rawDescGZIP() []byte {
	file_games_luckywheel_record_proto_rawDescOnce.Do(func() {
		file_games_luckywheel_record_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_games_luckywheel_record_proto_rawDesc), len(file_games_luckywheel_record_proto_rawDesc)))
	})
...
var file_games_luckywheel_record_proto_goTypes = []any{
...
func file_games_luckywheel_record_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_games_luckywheel_record_proto_rawDesc), len(file_games_luckywheel_record_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
